...
pub(crate) fn tool_option_key(tool_id: &str, setting_key: &str) -> String {
    format!("{tool_id}.{setting_key}")
}

pub(crate) fn set_tool_options(
...
pub(crate) fn normalize_tool_setting_value(
...
pub(crate) fn normalize_tool_settings_for_specs(
    settings: &serde_json::Value,
...
pub(crate) fn normalize_tool_setting_for_kind(
    value: serde_json::Value,
...
pub(crate) fn get_tool_setting_value<'a>(
...
pub(crate) fn set_nested_tool_setting(
...
pub(crate) fn apply_derived_tool_settings(
...
pub(crate) fn tool_apply_signature(settings: &serde_json::Value) -> serde_json::Value {
...
pub(crate) fn tool_apply_is_pending(
...
pub(crate) fn format_tool_availability(
...
pub(crate) fn build_tool_derived_facts(
    context: Option<&modde_games::tools::ToolGameContext>,
) -> Vec<(String, String)> {
...
pub(crate) fn patch_tool_setting_options(
    tool_id: &str,
...
pub(crate) fn installable_tool_assets(
    tool_id: &str,
...
pub(crate) fn tool_assets_for_tag(
    tool_id: &str,
...
pub(crate) fn optiscaler_release_tags_for_config(
    releases: &[modde_games::tools::ToolReleaseSummary],
    config: &modde_games::tools::ToolConfig,
) -> Vec<String> {
    releases
...
pub(crate) fn first_optiscaler_release_for_config(
    releases: &[modde_games::tools::ToolReleaseSummary],
    config: &modde_games::tools::ToolConfig,
...
pub(crate) fn sync_optiscaler_release_options(
...
pub(crate) fn current_tool_config_blocking(
...
pub(crate) async fn current_tool_config_async(
    db: &modde_core::db::ModdeDb,
    game_id: &str,
    tool_id: &str,
) -> Result<modde_games::tools::ToolConfig, String> {
