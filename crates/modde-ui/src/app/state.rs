...
#[path = "state_parts/wabbajack.rs"]
mod wabbajack;

pub(super) use self::wabbajack::prefill_wabbajack_game_dir;
pub use self::wabbajack::{WabbajackInstallerState, WabbajackTab};
...
#[derive(Debug, Clone)]
pub(crate) struct ToolLoadRequest {
