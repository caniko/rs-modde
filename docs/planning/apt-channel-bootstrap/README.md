...
- The public-facing URL choice is settled in Phase 01 as `https://modde.rs/apt/` and propagated to every end-user doc by Phase 04. `https://caniko.codeberg.page/rs-modde-apt/` remains the Codeberg Pages origin URL for bootstrap and backend verification.
