...
2. Every distribution channel the project _claims_ to support (README, website, install docs) vs. what the workflow actually publishes — list mismatches.
...
- [ ] Every Forgejo secret consumed by the _current_ workflow is listed, and every additional secret that phases 02–09 will need is listed with the channel that requires it.
